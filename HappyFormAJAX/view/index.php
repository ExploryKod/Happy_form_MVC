    ...
    <main>
        <section class="form-container">
                <form action="../data/register.php" method="POST">
                    ...
                    <input class="input" type="text" name="first_name" id="first_name" aria-required="true" required>

                    <label for="last_name">Nom <span>*</span> :</label>
                    <input class="input" type="text" name="last_name" id="last_name" aria-required="true" required>
                    
                    <label for="address">Adresse <span>*</span> :</label>
                    <textarea class="input" name="address" id="address" cols="30" rows="4" placeholder="Indiquez ici: n° de rue, rue, ville, code-postal" onfocus="this.onfocus=null;" aria-required="true" required></textarea>
...
<script type="module" src="javaScript/fetchData.js?<?php echo time(); ?>"></script>
